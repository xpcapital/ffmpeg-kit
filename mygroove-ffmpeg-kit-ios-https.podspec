...
Pod::Spec.new do |s|
  s.name         = "xpcapital-ffmpeg-kit-ios-https"
  s.version      = "6.0.2"
  ...
  s.source       = { :http => "https://github.com/my-groove/ffmpeg-kit/releases/download/v6.0.2-xpcapital/ffmpeg-kit-https-6.0-ios-xcframework.zip"}
